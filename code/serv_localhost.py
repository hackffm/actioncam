...
class WebApplication(tornado.web.Application):
    def __init__(self, configuration, database, helper):
        ...
        handlers = [
            (r'/database', HandlerDatabase, dict(configuration=configuration, database=database, helper=helper))
        ]
...
class ServLocalhost:
    def __init__(self, configuration, database, helper):
        ...
        ws_app = WebApplication(self.configuration, self.database, self.helper)
